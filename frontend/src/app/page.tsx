    ...
    <>
      <Layout>
        ...
        <ImageAndTextSection
          ...
          paragraph="On s’est posé la même question."
          text="C’est pourquoi on a créé le Club des Familles : une sélection de lieux testés (et approuvés) par des parents, pour des parents. \n Fini les galères, place aux sorties sereines en famille."
          image={Test}
          withButton={true}
        />
